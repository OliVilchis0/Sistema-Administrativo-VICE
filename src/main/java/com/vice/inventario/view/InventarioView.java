...
public class InventarioView {
	...
	public void init() {
		...
		columnCondicion.setCellValueFactory(new PropertyValueFactory<>("condicion"));
		...
		menuContext.getItems().addAll(addItem,removeItem,deleteItem);
	...
	public TableColumn<Inventario, Byte> columnCondicion;
	...
	public MenuItem addItem,removeItem,deleteItem;
	private VBox vbox;
